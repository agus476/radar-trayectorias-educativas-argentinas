...
El proyecto trabaja con bases educativas históricas de Argentina organizadas por año y temática. Las fuentes crudas se encuentran en `Step 1 - Dataset Propuesto/` y los datasets consolidados iniciales están en `Step 2 - Formateo/`.
...
```text
.
├── Step 1 - Dataset Propuesto/                 # Datasets crudos por año
├── Step 2 - Formateo/                          # Concatenación y datasets consolidados
├── Step 3 - Limpieza Inicial/                  # Limpieza general
├── Step 4 - Tratamiento de Nulos - Outliers/   # QA, nulos, outliers y normalización
├── Step 5 - Creacion de tablas e ingesta de datos/ # Creación de tablas e ingesta SQL
├── Step 6 - Visualización de Datos/            # Notebook previo de visualización
